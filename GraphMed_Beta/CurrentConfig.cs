    ...
    public sealed class CurrentConfig
    {
        ...
        public string SnomedImportPath
        {
            ...
            set
            {
                ...
                Descriptions = String.Concat(value, @"\Snapshot\Terminology\sct2_Description_Snapshot-en_INT_", SnomedVersion, ".txt");
                Concepts = String.Concat(value, @"\Snapshot\Terminology\sct2_Concept_Snapshot_INT_", SnomedVersion, ".txt");
                Relationships = String.Concat(value, @"\Snapshot\Terminology\sct2_Relationship_Snapshot_INT_", SnomedVersion, ".txt");
                Refset = String.Concat(value, @"\Snapshot\\Refset\Language\der2_cRefset_LanguageSnapshot-en_INT_", SnomedVersion, ".txt");
            }
        }
